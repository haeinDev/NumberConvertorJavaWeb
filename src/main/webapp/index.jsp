...
<body>
    ...
    <div id="content">
        ...
        <div class="container">
            ...
            <div class="front">
                ...
                <div class="value_front" id="value_front">0</div>
            ...
            <div class="back">
                <div class="decrement"></div>
                <div class="value_back" id="value_back">0</div>
                <div class="increment"></div>
            </div>
        ...
        <br>
        <br><br>
        <form name="Test" method="post" action="NumberConvertorServlet">
            <div>
            <input type="hidden" name="inputValue" id='inputMax' />
            <div class="wrapper">
                <input type="submit"  class ="button" value="Number Check" onclick='getInputText()'><br><br>
            </div>
        </div>
        </form>
    </div>
   ...
   <script>
       //this is to pass the only one input value to servlet 
        function getInputText() {
            var txt = $('#value_front').text();
            var txt2 = $('#value_back').text();
            console.log("front" + txt);
            console.log("back" + txt2);
            document.getElementById("inputMax").value = Math.max(txt, txt2);
